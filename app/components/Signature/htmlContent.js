...
<body onselectstart="return false">
  <div id="signature-pad" class="m-signature-pad">
    ...
    <div class="m-signature-pad--footer">
      ...
      <button type="button" class="button black" data-action="changeBlack"></button>
      <button type="button" class="button blue" data-action="changeBlue"></button>
    </div>
  </div>
